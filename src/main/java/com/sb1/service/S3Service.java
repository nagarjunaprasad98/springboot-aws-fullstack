...
public class S3Service {
    ...
    public byte[] downloadFile(String key) {
        ResponseBytes<GetObjectResponse> objAsBytes = s3Client.getObjectAsBytes(GetObjectRequest.builder().bucket(bucketName).key(key).build());
        return objAsBytes.asByteArray();
    }
